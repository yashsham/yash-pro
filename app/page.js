...
<section><section class="bg-slate-950 py-12">
  <div class="container mx-auto px-4">
    <div class="text-center mb-12">
      <h2 class="text-4xl font-semibold text-white animate-bounce">Welcome to Our Service</h2>
      <p class="mt-4 text-lg text-white animate-fade-in">We provide the best solutions for your needs</p>
    </div>
    <div class="flex flex-wrap justify-center">
      <div class="w-full md:w-1/3 px-4 mb-8">
        <div class="bg-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
          <h3 class="text-2xl font-semibold text-gray-800">Graphic Designing</h3>
          <p class="mt-4 text-gray-600">This feature is amazing and will greatly benefit your experience on our website. </p>
        </div>
      </div>
      <div class="w-full md:w-1/3 px-4 mb-8">
        <div class="bg-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
          <h3 class="text-2xl font-semibold text-gray-800">Content Creation</h3>
          <p class="mt-4 text-gray-600">Our users love this feature for its efficiency and ease of use. Imporve Thinking and Explore creativity. </p>
        </div>
      </div>
      <div class="w-full md:w-1/3 px-4 mb-8">
        <div class="bg-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300">
          <h3 class="text-2xl font-semibold text-gray-800">Genrative AI</h3>
          <p class="mt-4 text-gray-600">This feature sets us apart from the competition with its unique capabilities. </p>
        </div>
      </div>
    </div>
  </div>
</section>
</section><section class="bg-gray-800 py-12">
  <div class="container mx-auto px-4">
    <div class="text-center mb-12">
      <h2 class="text-4xl font-semibold text-white animate-pulse">Top YouTube Channel Videos</h2>
      <p class="mt-4 text-lg text-white animate-fade-in">Check out our latest and greatest video content</p>
    </div>
    <div class="flex justify-center space-x-4">
      <div class="w-full md:w-1/3 px-4 mb-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
          <iframe class="w-full h-64 md:h-96" src="https://www.youtube.com/embed/PjQ73zlMRhI?si=lTLuTziXzi-XiECe" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
      <div class="w-full md:w-1/3 px-4 mb-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
          <iframe class="w-full h-64 md:h-96" src="https://www.youtube.com/embed/xycPZ94C6lk?si=6mQLfhQx7vC_drqV" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
      <div class="w-full md:w-1/3 px-4 mb-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden transform hover:scale-105 transition duration-300">
          <iframe class="w-full h-64 md:h-96" src="https://www.youtube.com/embed/yRL09WCkDwo?si=v0pLLZaJd9VicxKd" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </div>
